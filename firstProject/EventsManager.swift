...
class EventsManager: ObservableObject {
    ...
    func addevent(event: Event){
        ...
        ref.setData(["Id":documentId,"Name": self.getUserName(),"Email":self.getUserEmail(), "Location":event.location, "Number of swipes":event.numberOfSwipes, "Time": event.time, "Message": event.message, "PhoneNo": event.phoneNo, "createdTime": event.dateCreated, "Reserved":event.reserved]){
            error in
            if let error = error{
                print(error.localizedDescription)
            }
    ...
    func updateEvent(event: Event){
        ...
        let documentId = ref.documentID // This is generated by firebase
        ref.setData(["Id":documentId,"Name": event.name,"Email":event.email, "Location":event.location, "Number of swipes":event.numberOfSwipes, "Time": event.time, "Message": event.message, "PhoneNo": event.phoneNo, "createdTime": event.dateCreated, "Reserved":event.reserved]){
            error in
            if let error = error {
